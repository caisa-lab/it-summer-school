...
class TextGroup(object):
    ...
    def setupText(self):
        ...
        self.alltext[LEVELTXT] = Text("0".zfill(8), WHITE, 20*TILEWIDTH, TILEHEIGHT, size)
        ...
        self.addText("SCORE P1", WHITE, 0, 0, size)
        self.addText("SCORE P2", WHITE, 20*TILEWIDTH, 0, size)
    ...
    def updateScore(self, score, index):
        self.updateText(index, str(score).zfill(8)) # was SCORETXT but we need the 0 and 1 spots and removing level text
