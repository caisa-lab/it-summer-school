"""
Wir möchten, dass die Peppers wieder an den oberen 
Rand des Screens zurückkehren, wenn sie den Boden 
berühren.

Handle events: Pepper berührt den Boden
Update game state: Die y-Position des Rectangles 
                   sollte zurückgesetzt werden
Draw: Das Rectangle wird an der richtigen Position 
      gezeichnet
"""
import sys, pygame 
...
pygame.display.set_caption('Pepper Conditional Update') 
